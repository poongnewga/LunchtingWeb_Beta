...
# admin:
User.create(nickname: "admin", password: "fjsclxldghkdlxld!", age: "26", gender: "m", email: "asdf@asdf.com",
...
User.create(nickname: "해커톤1", password: "1234", age: "26", gender: "m", email: "d1g1mong@naver.com",
            company: "고려대학교", location: {latitude: 37.498116, longitude: 127.027642}.to_json,
            lunchtime: "{\"start\":\"11:30 AM\",\"finish\":\"13:00 PM\"}", photo: nil, card: nil,
            token: "hi", notice: true, push: true, push_token: "hi", email_confirmed: true)

User.create(nickname: "해커톤2", password: "1234", age: "26", gender: "f", email: "asddf@asdf.com",
            company: "서강대학교", location: {latitude: 37.497806, longitude: 127.026023}.to_json,
            lunchtime: "{\"start\":\"11:30 AM\",\"finish\":\"13:00 PM\"}", photo: nil, card: nil,
            token: "hi", notice: true, push: true, push_token: "hi", email_confirmed: true)
...
# group
@mg1 = Group.create(gender: "m", people: 2, location: {latitude: 37.498479, longitude: 127.026969}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"1\",\"wed\":\"0\",\"thu\":\"0\",\"fri\":\"0\"}", week: 20170821,
...
@mg2 = Group.create(gender: "m", people: 2, location: {latitude: 37.491842, longitude: 127.007778}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"1\",\"wed\":\"1\",\"thu\":\"1\",\"fri\":\"0\"}", week: 20170821,
            lunchtime: "{\"start\":\"12:00 PM\",\"finish\":\"13:30 PM\"}", matched: true, company: "엘지화학")
User.find_by(nickname: "male_3").groups << @mg2
User.find_by(nickname: "male_4").groups << @mg2

@fg1 = Group.create(gender: "f", people: 2, location: {latitude: 37.497900, longitude: 127.027624}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"1\",\"wed\":\"0\",\"thu\":\"1\",\"fri\":\"0\"}", week: 20170821,
            lunchtime:"{\"start\":\"12:00 PM\",\"finish\":\"13:30 PM\"}", matched: true, company: "마이크로소프트")
...
@fg2 = Group.create(gender: "f", people: 2, location: {latitude: 37.497139, longitude: 127.028553}.to_json,
            day: "{\"mon\":\"0\",\"tue\":\"1\",\"wed\":\"1\",\"thu\":\"0\",\"fri\":\"0\"}", week: 20170821,
            lunchtime: "{\"start\":\"12:00 PM\",\"finish\":\"13:30 PM\"}", matched: true, company: "메리츠화재")
...
@mg_1 = Group.create(gender: "m", people: 1, location: {latitude: 37.498203, longitude: 127.030051}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"0\",\"wed\":\"1\",\"thu\":\"0\",\"fri\":\"0\"}", week: 20170821,
            lunchtime: "{\"start\":\"11:30 AM\",\"finish\":\"13:00 PM\"}", matched: true, company: "DK음악학원")
...
@fg_1 = Group.create(gender: "f", people: 1, location: {latitude: 37.498552, longitude: 127.030845}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"0\",\"wed\":\"0\",\"thu\":\"1\",\"fri\":\"0\"}", week: 20170821,
            lunchtime: "{\"start\":\"11:30 AM\",\"finish\":\"13:00 PM\"}", matched: true, company: "삼성전자")
...
@mg_2 = Group.create(gender: "m", people: 1, location: {latitude: 37.497200, longitude: 127.026264}.to_json,
            day: "{\"mon\":\"0\",\"tue\":\"0\",\"wed\":\"0\",\"thu\":\"1\",\"fri\":\"0\"}", week: 20170821,
            lunchtime: "{\"start\":\"11:30 AM\",\"finish\":\"13:00 PM\"}", matched: true, company: "네이버")
...
@fg_2 = Group.create(gender: "f", people: 1, location: {latitude: 37.495650, longitude: 127.028146}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"0\",\"wed\":\"0\",\"thu\":\"1\",\"fri\":\"0\"}", week: 20170821,
            lunchtime: "{\"start\":\"11:30 AM\",\"finish\":\"13:00 PM\"}", matched: true, company: "우리은행")
...
@mg_3 = Group.create(gender: "m", people: 1, location: {latitude: 37.497200, longitude: 127.026264}.to_json,
            day: "{\"mon\":\"0\",\"tue\":\"0\",\"wed\":\"1\",\"thu\":\"0\",\"fri\":\"1\"}", week: 20170821,
            lunchtime: "{\"start\":\"12:00 PM\",\"finish\":\"13:00 PM\"}", matched: true, company: "네이버")
...
@fg_3 = Group.create(gender: "f", people: 1, location: {latitude: 37.498615, longitude: 127.028705}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"0\",\"wed\":\"0\",\"thu\":\"1\",\"fri\":\"0\"}", week: 20170821,
            lunchtime: "{\"start\":\"12:00 PM\",\"finish\":\"13:00 PM\"}", matched: true, company: "마이크로소프트")
...
@mg_5 = Group.create(gender: "m", people: 1, location: {latitude: 37.497200, longitude: 127.026264}.to_json,
            day: "{\"mon\":\"0\",\"tue\":\"0\",\"wed\":\"0\",\"thu\":\"0\",\"fri\":\"1\"}", week: 20170821,
            lunchtime: "{\"start\":\"12:00 PM\",\"finish\":\"13:00 PM\"}", matched: true, company: "네이버")
...
@mg3_3 = Group.create(gender: "m", people: 3, location: {latitude: 37.497200, longitude: 127.026264}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"0\",\"wed\":\"0\",\"thu\":\"0\",\"fri\":\"1\"}", week: 20170821,
            lunchtime: "{\"start\":\"12:00 PM\",\"finish\":\"13:00 PM\"}", matched: true, company: "네이버")
...
@fg3_3 = Group.create(gender: "f", people: 3, location: {latitude: 37.498148, longitude: 127.030714}.to_json,
            day: "{\"mon\":\"1\",\"tue\":\"1\",\"wed\":\"0\",\"thu\":\"1\",\"fri\":\"1\"}", week: 20170821,
...
#미팅
@m1 = Meeting.create(date: 20170824, day: "목", lunchtime: "{\"start\":\"12:00\",\"finish\":\"13:00\"}", center: {latitude: 37.49852100354786, longitude: 127.02778749884503}.to_json,
...
@m2 = Meeting.create(date: 20170822, day: "화", lunchtime: "{\"start\":\"12:00\",\"finish\":\"13:00\"}", center: {latitude: 37.49754795419014, longitude: 127.0275}.to_json,
...
@m3 = Meeting.create(date: 20170821, day: "월", lunchtime: "{\"start\":\"11:30\",\"finish\":\"13:00\"}", center: {latitude: 37.49837750066425, longitude: 127.0304}.to_json,
...
@m4 = Meeting.create(date: 20170815, day: "화", lunchtime: "{\"start\":\"12:00\",\"finish\":\"13:00\"}",
...
@m5 = Meeting.create(date: 20170823, day: "수", lunchtime: "{\"start\":\"12:00\",\"finish\":\"13:00\"}",
...
@m6 = Meeting.create(date: 20170821, day: "월", lunchtime: "{\"start\":\"12:00\",\"finish\":\"13:00\"}",
